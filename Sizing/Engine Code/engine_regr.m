...
function [F_th_mil, TSFC_mil, F_th_AB, TSFC_AB] = engine_regr(h_geom, M_inf, F_static_mil, F_static_AB, n_engine)
...
h_geom_SI = 0.3048*h_geom; % meters
...
F_th_mil = F_static_mil * alpha_dry * n_engine; %lbf
F_th_AB = F_static_AB * alpha_AB * n_engine; %lbf
