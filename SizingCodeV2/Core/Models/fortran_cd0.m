...
caseDef.components = struct( ...
    ...
    "Swet",  {m2ft(m2ft(geom.fuselage.area.v)),    m2ft(m2ft(4*geom.wing.area.v)),   m2ft(m2ft(4*geom.elevator.area.v)),  m2ft(m2ft(4*geom.rudder.area.v))}, ... % top and bottom
