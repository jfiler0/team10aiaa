...
% Jeffrey - this was initially supposed to output to fprintf. I changed it to just return the wrapped string. Also added a catch for when no
% wrapping was actually needed because the function behaved stragely
...
if( length(str) <= width )
    newstr = str; % There is no need to wrap
else
